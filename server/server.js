...
var alphaList = 'a b c d e f g h i j k l m n o p q r s t u v w x y z'.split(' ');
var ranAlpha = [];
var i;
for (i=0;i<26;i++){
	ranAlpha.push(alphaList[Math.floor(Math.random() * alphaList.length)])
}
var mySecret = new Date().getTime() + ranAlpha.toString();
...
app.use(session({
  ...
  store: sessionStore,
  secret: mySecret,  //  replace w/ rndm key generated by env variables
  resave: false,
